...
document.getElementById("textBtn").classList.remove("tab-active");
...
document.getElementById("textBtn").classList.add("tab-active");
document.getElementById('fileBtn').classList.remove('tab-active')
